...
from torch.nn.init import xavier_uniform, kaiming_uniform
...
def weights_init(n):
    ...
    if isinstance(n, nn.Linear) or isinstance(n, nn.Conv2d):
        print('Initializing xavier_uniform weights for layer: {0}'.format(n))
...
for epoch in range(1, args.epochs + 1):
    #print('Running with dropout probability: {0}'.format(p))
